...
// BGG mmx
//    for some reason w/ max5 heavy parsing/scheduling of shreds sometimes
//    caused this condition, so I juet reset wake_time to now.  Whatta guy
//        EM_error3( "[chuck](VM): internal sanity check failed in shredule()" );
//        EM_error3( "[chuck](VM): (wake time is past) - %f : %f", wake_time, this->now_system );

//        return FALSE;
			wake_time = this->now_system;
    }
