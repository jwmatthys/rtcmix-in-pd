...
// BGG mmx -- have to fix this, Chuck_Compiler::go() is set to take input
// from a buffer in max/msp
/*
...
// BGG mmx -- have to fix this, chuck_parse() is set to take buffer input
// in max-msp
/*
